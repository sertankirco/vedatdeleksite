          ...
          <div className="p-8 lg:p-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-slate-600 dark:text-slate-400 mb-8 pb-8 border-b border-slate-200 dark:border-slate-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  {getReadingTimeText(getReadingTime(getContent(post)))}
                </span>
              </div>
              <div className="text-sm">
                {language === "tr"
                  ? "Vedat Delek tarafından yazılmıştır"
                  : language === "en"
                    ? "Written by Vedat Delek"
                    : "Γράφτηκε από τον Vedat Delek"}
              </div>
            </div>
                ...
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    {language === "tr"
                      ...
                      : language === "en"
                        ? "Astrologer Vedat Delek"
                        : "Αστρολόγος Vedat Delek"}
                  </p>
                  <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">
                    {language === "tr"
                      ? "20+ yıllık astroloji deneyimi"
                      : language === "en"
                        ? "20+ years of astrology experience"
                        : "20+ χρόνια εμπειρίας αστρολογίας"}
                  </p>
                </div>
                <Button
