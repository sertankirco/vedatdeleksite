...
const translations = {
  tr: {
    ...
    "nav.profile": "Profil",
    "footer.rights":
      "© 2024 Vedat Delek Astroloji Platformu. Tüm hakları saklıdır.",
    "footer.tagline":
      "Yıldızlar aracılığıyla yaşamı anlamak ve geleceği şekillendirmek.",
    "home.hero.title": "Yıldızların Rehberliğinde Kaderinizi Keşfedin",
    "home.hero.subtitle":
      "Astrolog Vedat Delek'in İnternet Sitesine Hoşgeldiniz",
    ...
    "home.features.feature1.description":
      "Doğum haritası analizi ve karmik rehberlik ile özel danışmanlık hizmetleri",
    "home.features.feature2.title": "Astroloji Rehberi",
    "home.features.feature2.description":
      "Blog yazıları ve video içeriği ile derinlemesine bilgi",
    "home.features.feature3.title": "Yıldızların Gücü",
    "home.features.feature3.description":
      "Evrensel enerjileri anlamak ve yaşamınızı dönüştürmek",
    "home.cta.title": "Kişisel Astroloji Hizmetleri",
    "home.cta.subtitle":
      "Doğum haritası analizi, karmik rehberlik ve daha fazlası için Vedat Delek'in premium hizmetlerini keşfedin.",
    ...
    "shop.buy": "Satın Al",
    "shop.empty":
      "Şu anda hiçbir hizmet bulunmamaktadır. Lütfen daha sonra tekrar kontrol edin.",
    ...
    "contact.description":
      "Doğum haritası analizi, karmik rehberlik ve kişisel astroloji danışmanlığı için Vedat Delek ile iletişime geçin.",
    "contact.follow": "Sosyal Medyada Takip Edin",
    "contact.follow.desc":
      "Günlük burç yorumları, astroloji ipuçları ve özel duyurular için sosyal medya hesaplarımızı takip edin.",
  ...
  en: {
    ...
    "nav.profile": "Profile",
    "footer.rights":
      "© 2024 Vedat Delek Astrology Platform. All rights reserved.",
    "footer.tagline":
      "Understanding life through the stars and shaping your future.",
    ...
    "home.features.feature1.description":
      "Special consultation services with birth chart analysis and karmic guidance",
    "home.features.feature2.title": "Astrology Guide",
    "home.features.feature2.description":
      "In-depth information with blog articles and video content",
    "home.features.feature3.title": "Power of the Stars",
    "home.features.feature3.description":
      "Understanding universal energies and transforming your life",
    "home.cta.title": "Personal Astrology Services",
    "home.cta.subtitle":
      "Discover Vedat Delek's premium services for birth chart analysis, karmic guidance and more.",
    ...
    "contact.description":
      "Contact Vedat Delek for birth chart analysis, karmic guidance, and personal astrology consultation.",
    "contact.follow": "Follow on Social Media",
    "contact.follow.desc":
      "Follow our social media accounts for daily horoscopes, astrology tips, and special announcements.",
    "contact.instagram": "Instagram",
    "contact.youtube": "YouTube",
    "contact.twitter": "X (Twitter)",
    "contact.facebook": "Facebook",
  ...
  el: {
    ...
    "nav.profile": "Προφίλ",
    "footer.rights":
      "© 2024 Πλατφόρμα Αστρολογίας Vedat Delek. Όλα τα δικαιώματα διατηρούνται.",
    "footer.tagline":
      "Κατανοώντας τη ζωή μέσω των αστέρων και διαμορφώνοντας το μέλλον σας.",
    "home.hero.title": "Ανακαλύψτε το Πεπρωμένο σας Κάτω από τα Αστέρια",
    "home.hero.subtitle":
      "Καλώς ήρθατε στο Δικτυακό Τόπο του Αστρολόγου Vedat Delek",
    ...
    "home.features.feature1.description":
      "Ειδικές υπηρεσίες συμβουλευτικής με ανάλυση αστρικής χάρτας και κάρμικη καθοδήγηση",
    "home.features.feature2.title": "Οδηγός Αστρολογίας",
    "home.features.feature2.description":
      "Βαθύ περιεχόμενο με άρθρα και βίντεο",
    "home.features.feature3.title": "Δύναμη των Αστέρων",
    "home.features.feature3.description":
      "Κατανοώντας τις καθολικές ενέργειες και μετασχηματίζοντας τη ζωή σας",
    "home.cta.title": "Υπηρεσίες Προσωπικής Αστρολογίας",
    "home.cta.subtitle":
      "Ανακαλύψτε τις premium υπηρεσίες του Vedat Delek για ανάλυση αστρική χάρτα, κάρμικη καθοδήγηση και άλλα.",
    "home.cta.button": "Περιήγηση Υπηρεσιών",

    "shop.title": "Υπηρεσίες Αστρολογίας",
    "shop.subtitle":
      "Ειδικές υπηρεσίες συμβουλευτικής και ανάλυσης του Vedat Delek",
    "shop.buy": "Αγορά",
    "shop.empty":
      "Δεν υπάρχουν διαθέσιμες υπηρεσίες αυτή τη στιγμή. Παρακαλώ ελέγξτε αργότερα.",
    ...
    "admin.forbidden.text":
      "Χρειάζεστε δικαιώματα διαχειριστή για να αποκτήσετε πρόσβαση σε αυτή τη σελίδα.",
    ...
    "admin.info":
      "Χρησιμοποιήστε τον πίνακα διαχείρισης για να διαχειριστείτε τα άρθρα blog, τα βίντεο και τα προϊόντα.",
    ...
    "contact.description":
      "Επικοινωνήστε με τον Vedat Delek για ανάλυση αστρικής χάρτας, κάρμικη καθοδήγηση και προσωπική συμβουλευτική αστρολογίας.",
    "contact.follow": "Ακολουθήστε στα Κοινωνικά Μέσα",
    "contact.follow.desc":
      "Ακολουθήστε τους λογαριασμούς μας στα κοινωνικά μέσα για καθημερινά ωροσκόπια, συμβουλές αστρολογίας και ειδικές ανακοινώσεις.",
    "contact.instagram": "Instagram",
    "contact.youtube": "YouTube",
    "contact.twitter": "X (Twitter)",
    "contact.facebook": "Facebook",
